...
//                    robot.servoScreen.setPosition(0.8);
                ...
                case LINE_UP_GOLD:
                    ...
                    if (goldMineralPos.equals(GoldMineralPos.LEFT)) {
                        ...
                        timeDrive(0.5, 1.7, 75.0);
                        gyroHold(0.35, -45.0, 1.0);
                    } else {
                        timeDrive(0.5, 0.8, 60.0);
                        gyroHold(0.35, -20.0, 1.0);
                    }
                ...
                case PUSH_GOLD:
                    ...
                    if (goldMineralPos.equals(GoldMineralPos.LEFT)) {
                        timeDrive(0.5, 1.5, 10.0);
                    } else if (goldMineralPos.equals(GoldMineralPos.RIGHT)) {
                        timeDrive(0.5, 1.5, -35.0);
                        timeDrive(0.5, 0.8, -55.0);
                    } else {
                        timeDrive(0.5, 1.4, -20.0);
                    }
                ...
                case MOVE_TO_CRATER:
                    ...
                    timeDrive(0.5, 0.7, -130.0);

                    gyroHold(0.35, 135.0, 2.0);

                    timer.reset();
                    while (opModeIsActive() && robot.rangeRear.getDistance(DistanceUnit.CM) > 15 && timer.seconds() < 3) {
                        timeDrive(0.35, 0.2, -45.0);
                    }

                    timeDrive(0.5, 0.5, -135.0);

                    int travelCount = 0;
                    while (travelCount++ < 2) {
                        double distRear = robot.rangeRear.getDistance(DistanceUnit.CM);
                        if (distRear > 30) {
                            timeDrive(0.5, 1.0, -130.0);
                        } else if (distRear < 10) {
                            timeDrive(0.5, 1.0, -150.0);
                        } else {
                            timeDrive(0.5, 1.0, -140.0);
                        }
                    }
